  ...
  return (
    ...
    <PopoverContent w="98%" p="10px">
      ...
      <HStack justifyContent={"space-between"} spacing={"35px"}>
        ...
        <Image
          src="https://images.ctfassets.net/5de70he6op10/2LPXdx7dUFAppQDZV1L4fO/ececfee98b03a595ff9163d57cc1a6a0/110822_Gateway_slice05.jpg?w=1095&q=80&fm=webp"
          w="350px"
          h="450px"
          alt="gift"
        />
